...
import { buyGroupCoaching } from '@/services/private/customer/groupCoaching';
...
const Page = () => {
  ...
  const {
    ...
    queryFn: () => buyGroupCoaching({ id: eventId }),
    queryKey: [queryKeys.checkoutGroupCoaching, eventId],
  });
