  ...
  const {
    ...
    queryFn: () =>
      createGuestCheckoutSession({
        type: 'consultation',
        object_id: Number(consultationId) || consultationId,
      }),
    queryKey: [queryKeys.guestCheckoutSession, 'consultation', consultationId],
    ...
    <div className="flex flex-col gap-5">
      ...
      <LoadingWrapper isLoading={isLoading}>
        {clientSecret ? (
          ...
          <div className="text-center">Checkout Consultation Session not created properly</div>
        )}
      </LoadingWrapper>
    </div>
  );
