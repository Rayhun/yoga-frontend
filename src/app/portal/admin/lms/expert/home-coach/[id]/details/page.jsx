...
import HomeCoachDetails from '@/components/lms/expert/HomeCoachDetails';
...
const Page = ({ params }) => {
  ...
  return (
    <div>
      <PageHeader title="Home Coach Configuration Details">
        <PageHeaderQuickActions actions={headerActions} />
      </PageHeader>
      <HomeCoachDetails data={response?.data?.data} />
    </div>
  );
};
