          ...
          <div className="hidden lg:flex lg:w-1/2 bg-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col justify-center items-center text-center px-12 py-16">
              <Link className="mb-8 inline-block transform hover:scale-105 transition-transform duration-300" href="/">
                <Image src="/images/logo/logo.png" alt="Logo" width={200} height={40} />
              </Link>

              <div className="space-y-6 animate-slideInLeft">
                <h1 className="text-4xl font-bold text-gray-800 leading-tight">
                  <span className="text-orange-600">Your Wellness Journey</span>{' '}
                  Starts Here.
                </h1>

                <p className="text-gray-600 text-lg leading-relaxed max-w-md">
                  Join NourishDoc and connect with expert coaches guiding you through midlife wellness, nutrition, and beyond.
                </p>

                <div className="mt-8 w-full max-w-md mx-auto">
                  <div className="space-y-3">
                    {[
                      'Access Expert-Led Programs',
