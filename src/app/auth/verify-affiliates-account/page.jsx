...
import AffiliatesAccountVerificationForm from '@/components/auth/AffiliatesAccountVerification';
          ...
          <div className="hidden lg:flex lg:w-1/2 bg-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col justify-center items-center text-center px-12 py-16">
              ...
              <div className="space-y-6 animate-slideInLeft">
                ...
                Almost there! Enter the verification code we just emailed you to activate your affiliate account and start earning commissions.</p>
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16">
            <div className="w-full max-w-md">
              ...
              <div className="animate-fadeIn">
                <AffiliatesAccountVerificationForm />
              </div>
            </div>
          </div>
        </div>
