...
import AffiliatesSignupForm from '@/components/auth/AffiliatesSignupForm';

export const metadata = {
  title: 'Affiliates Signup',
};

const Page = () => {
  return (
    <div className="w-[calc(100vw-20px)] min-h-[calc(100vh-20px)] m-[10px] md:w-[calc(100vw-100px)] md:min-h-[calc(100vh-100px)] md:m-[50px] rounded-sm border border-stroke bg-white flex shadow-default dark:border-strokedark dark:bg-boxdark">
