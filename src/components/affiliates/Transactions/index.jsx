...
import { getAffiliateTransactions } from '@/services/private/affiliates/dashboard';
...
const Transactions = () => {
  ...
  const {
    ...
    queryKey: [queryKeys.affiliateTransactions, statusFilter, searchQuery],
  });
      ...
      <div className="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white py-8 px-6 rounded-2xl shadow-2xl mb-6 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="font-bold text-2xl md:text-3xl">Transaction History</h1>
              <p className="text-green-100 text-sm md:text-base">View all your commission transactions and earnings</p>
            </div>
          </div>
        </div>
      </div>
        ...
        {filteredTransactions.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">
              {searchQuery || statusFilter ? 'Try adjusting your filters' : 'Your commission transactions will appear here'}
            </p>
          </div>
        ) : (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      {transaction.payout_due_date && (
                        <div className="text-xs text-gray-500 dark:text-gray-400">
                          Due: {formatDate(transaction.payout_due_date)}
                        </div>
                      )}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
