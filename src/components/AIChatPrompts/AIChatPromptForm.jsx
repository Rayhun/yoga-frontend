...
const AIChatPromptsForm = ({ selected }) => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      // Always add all form values to FormData
      ...
      // If chat type is faqs and file is uploaded, add the file
      if (selectedChatType === 'faqs' && uploadedFile) {
        formData.append('faq_file', uploadedFile, uploadedFile.name);
      }
      ...
      if (isEditMode) {
        // For edit mode, add the id to FormData
