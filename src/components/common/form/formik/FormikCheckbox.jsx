...
const FormikCheckbox = ({ name: fieldName, label, className, required = false, ...fieldProps }) => {
        ...
        <div className="relative">
          ...
          <div
            className={`mr-4 flex h-5 w-5 items-center justify-center rounded border ${
              field.checked && 'border-primary bg-gray dark:bg-transparent'
            }`}
          >
            <span className={`opacity-0 ${field.checked && '!opacity-100'}`}>
