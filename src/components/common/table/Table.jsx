    ...
    <section className="data-table-common data-table-two rounded-sm border border-stroke bg-white py-4 shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="flex justify-between border-t border-stroke px-8 pt-5 dark:border-strokedark">
        <p className="font-medium">
          Showing {pageIndex + 1} 0f {getPageCount()} pages
        </p>
        <div className="flex">
          <button
            className="flex cursor-pointer items-center justify-center rounded-md p-1 px-2 hover:bg-primary hover:text-whiter disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:text-inherit"
          ...
          {getPageOptions().map((_page, index) => (
            <button
              key={index}
              onClick={() => {
                setPageIndex(index);
