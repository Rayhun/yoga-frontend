  ...
  return (
    <div className="col-span-12 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-5">
      <div className="flex justify-between border-b border-stroke px-6 py-5 dark:border-strokedark">
        <div>
          <h2 className="mb-1.5 text-title-md2 font-bold text-black dark:text-white">Campaign Visitors</h2>
          <p className="text-sm font-medium">Last Campaign Performance</p>
        </div>
        <div>
          <h3 className="mb-1.5 text-title-md2 font-bold text-black dark:text-white">784k</h3>
