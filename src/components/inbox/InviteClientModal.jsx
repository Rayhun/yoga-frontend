...
import CommunityPageSection from './community/CommunityPageSection';
import {
  DEFAULT_COMMUNITY_COLORS,
  getCommunityColor,
} from './community/communityColors';
import {
...
const InviteClientModal = ({ open, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] overflow-y-auto">
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        <div
          className="relative w-full max-w-xl rounded-3xl px-5 py-7 shadow-2xl md:px-8 md:py-9"
